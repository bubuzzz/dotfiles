"""Sakura — the pink/lilac Cozytile palette, with the tuned bar.

Structure lives in themes/_cozytile.py; this file is the colours plus the same
departures from upstream that everforest uses.  Note that Sakura shares Cozy's
outer/island tones and differs only in its accents.
"""
...
palette = {
    ...
    "fg": "#E5B9C6",
    "accent": "#CFB3E5",  # active workspace block
    # Upstream leaves this at Cozy's purple.  Inert under highlight_method
    # "block", so it is kept as shipped.
    "glow": "#4B427E",
    "border": "#3b4252",
    "float": "#1F1D2E",
}
...
#   python3 ~/.config/qtile/scripts/gen-gradient-slices.py sakura
